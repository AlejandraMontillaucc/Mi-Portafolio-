...
function VisualStudioCodeLogo({ className }: { className?: string }) {
  return (
    <svg viewBox="0 0 512 512" aria-hidden="true" className={className} fill="currentColor">
      <path d="m423 114-75-37a23 23 0 0 0-26 5L77 306a15 15 0 0 0 0 22l20 18a15 15 0 0 0 20 1l295-224c10-7 24-1 24 12v-1c0-9-5-17-13-20" />
      <path d="m423 399-75 36a23 23 0 0 1-26-5L77 207a15 15 0 0 1 0-22l20-19a15 15 0 0 1 20-1l295 224c10 8 24 1 24-12v1c0 9-5 17-13 21" />
      <path d="M348 435a23 23 0 0 1-26-5c9 9 23 3 23-9V92c0-12-14-19-23-10a23 23 0 0 1 27-4l75 36c7 3 12 11 12 20v244c0 9-5 17-12 21" />
    </svg>
  );
}
...
export default function Skills() {
  ...
  const categories = useMemo(() => {
    ...
    const aiDevTools: Tech[] = [
      { name: 'ChatGPT', brand: '#10A37F', glow: 'rgba(16,163,127,0.26)', Logo: ChatGPTLogo },
      { name: 'Visual Studio Code', brand: '#007ACC', glow: 'rgba(0,122,204,0.24)', Logo: VisualStudioCodeLogo },
      { name: 'Claude', brand: '#D97706', glow: 'rgba(217,119,6,0.22)', Logo: ClaudeLogo },
    ];
    ...
    return [
      ...
      { title: t('aiTools'), description: t('aiToolsDesc'), items: aiDevTools },
    ];
  }, [isDark, t]);
